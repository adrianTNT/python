...
def addConnectionArgs(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    group.add_argument(
        ...
        "--tcp",
        "-t",
        help="Connect to a device using TCP, optionally passing hostname or IP address to use. (defaults to '%(const)s'). Tcp port can be specified like this: myhost:4403 ",
        nargs="?",
        default=None,
        const="localhost",
    )
